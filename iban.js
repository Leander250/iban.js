...
Specification.prototype.fromBBAN = function (bban) {
  ...
  const remainder = iso7064Mod97_10(
 ...
 * @returns {string|*}
 */
window.toBBAN = function (iban, separator) {
 ...
 * @returns {string} the IBAN
 */
window.fromBBAN = function (countryCode, bban) {
 ...
 */
window.isValidBBAN = function (countryCode, bban) {
  if (!isString(bban)) {
    return false
  }
  const countryStructure = countries[countryCode]
 ...
 * @returns {string}
 */
window.printFormat = function (iban, separator) {
  if (typeof separator == 'undefined') {
    separator = ' '
  }
...
window.electronicFormat = electronicFormat
/**
